...
import CategoriesTitle from "../../components/CategoriesTitle";
        ...
        export default function Home({}) {
          ...
          const fetchArticles = async () => {
            setLoading(true);
            try {
              const data = await fetcher(`/api/articles/pages?page=${page}&category=${'lifestyle'}`);
              ...
              <section className="">
                ...
                <div className="">
                  <div className="flex justify-center">
                    ...
                    Want to know how the rich and famous live? Discover the lavish lifestyles of your favorite 
                    celebrities and see how they spend their millions. 
                    From luxury cars to private jets, get a glimpse into the world of the elite. 
                    </p>
