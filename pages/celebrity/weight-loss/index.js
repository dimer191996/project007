...
export default function Home({}) {
  ...
  const fetchArticles = async () => {
    ...
    try {
      const data = await fetcher(
        `/api/articles/article/more/related/weight?page=${page}`
      );
  ...
  return (
    <SeoPage
      ...
      hearder={" Celebrity Weight Loss | HotSeatMag "}
      tags={"Celebrity Weight Loss"}
      keyword="Celebrity Weight Loss"
      category={"celebrity/weight-loss"}
    >
      <section className="">
        <div className="">
